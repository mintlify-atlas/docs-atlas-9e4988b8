...
curl -X GET https://your-app-url/api/municipalities/?province_id=1
```

```bash Filter by Province and District ID
curl -X GET "https://your-app-url/api/municipalities/?province_id=1&district_id=3"
```

```bash Filter by District Name
curl -X GET https://your-app-url/api/municipalities/?province_name=Koshi%20Province&district_name=Ilam
```
</RequestExample>
